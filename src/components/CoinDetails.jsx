...
import ErrorHandle from './EroorHandle';
...
const CoinDetails = () => {
  ...
  const [chartArray, setChartArary] = useState([]);  
  ...
  useEffect(() => {
    const fetchCoin = async () => {
      ...
      setCoin(data);
      setChartArary(chartData.prices);
      setLoading(false);
  ...
  return (
    <Container maxW={'container.xl'}>
        ...
        <>
          ...
          <RadioGroup justifyContent={'space-evenly'} value={currency} mt={'2'} onChange={setCurrency}>
            <HStack spacing={'4'}>
